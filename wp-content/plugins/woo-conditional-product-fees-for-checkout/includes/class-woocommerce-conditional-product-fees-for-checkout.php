...
class Woocommerce_Conditional_Product_Fees_For_Checkout_Pro
{
    ...
    private function define_admin_hooks()
    {
        ...
        $this->loader->add_action( 'woocommerce_cart_calculate_fees', $plugin_admin, 'calculate_cost' );
    }
    ...
    private function define_public_hooks()
    {
        ...
        $optional_fee_display_default_hook = apply_filters( 'optional_fee_display_default_hook', 'woocommerce_after_order_notes' );
