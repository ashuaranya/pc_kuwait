...
?>
<nav class="woocommerce-products-wizard-nav">
    <ul class="woocommerce-products-wizard-nav-list is-line" role="tablist">
        <?php foreach ($arguments['navItems'] as $navItem) { ?>
            <li role="presentation"
                ...
                <button type="submit" role="tab"
                    ...
                    class="woocommerce-products-wizard-nav-list-item-button <?php echo esc_attr($navItem['class']); ?>"
