...
?>
<nav class="woocommerce-products-wizard-nav is-buttons">
    <ul class="woocommerce-products-wizard-nav-list is-buttons nav" role="tablist">
        <?php foreach ($arguments['navItems'] as $navItem) { ?>
            <li role="presentation"
                ...
                <button type="submit" role="tab"
                    ...
                    class="woocommerce-products-wizard-nav-list-item-button btn btn-default btn-light <?php
