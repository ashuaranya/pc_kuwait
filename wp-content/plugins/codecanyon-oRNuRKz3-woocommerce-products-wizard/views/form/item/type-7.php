...
?>
<article class="<?php
    echo esc_attr($arguments['class'] . ' type-7' . ($arguments['cartItem'] ? ' is-in-cart' : ''));
    ?> product panel panel-default card"
    ...
    ?>>
    <div class="<?php echo esc_attr($arguments['class']); ?>-body card-body">
