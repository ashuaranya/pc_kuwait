...
?>">
    ...
    <?php foreach ($arguments['values'] as $value) { ?>
        <label class="woocommerce-products-wizard-form-filter-field-value-label checkbox-inline custom-control custom-checkbox custom-control-inline is-value-<?php echo esc_attr($value['id']); ?>">
            <input type="checkbox"
